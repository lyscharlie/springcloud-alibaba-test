package com.lyscharlie.test2.common.aop;
...
import com.lyscharlie.test2.common.annotation.EagleEye;
import com.lyscharlie.test2.common.annotation.RetryMethod;
...
public class AopTestAspect {
	...
	// 指定注解类型
	@Pointcut("@annotation(com.lyscharlie.test2.common.annotation.EagleEye)")
	...
	@Around("@annotation(com.lyscharlie.test2.common.annotation.RetryMethod)")
	...
	// 匹配包中的指定类的所有方法
	@Pointcut("execution(* com.lyscharlie.test2.biz.service.UserService.*(..))")
	...
	// 匹配指定包中的所有的方法, 包括子包
	@Pointcut("within(com.lyscharlie.test2.biz.service..*)")
